...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    controller.seekerId = int.parse(widget.seekerId);
    controller.companyId = int.parse(widget.companyId);
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  onPressed: () {
                                    if (controller.sendMessage.text.isEmpty) {
                                      ...
                                      controller.sendMessages(
                                          widget.isCompany == "yes" ? 0 : 1,
                                          int.parse(widget.companyId),
                                          int.parse(widget.seekerId),
                                          widget.receiverName);
                                    }
                                  },
